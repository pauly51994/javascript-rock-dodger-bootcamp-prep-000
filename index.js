...
function moveDodger(e) {
   ...
   */
   document.addEventListener('keydown', function(k){
     if (k.which === LEFT_ARROW){moveDodgerLeft()}
   });
   document.addEventListener('keydown', function(k){
     if (k.which === RIGHT_ARROW){moveDodgerRight()}
   });
}
...
function moveDodgerLeft() {
   ...
   */
   ...
   function moveleft() {
     ...
     if (left > 0) {window.requestAnimationFrame(moveleft)}
   }
...
function moveDodgerRight() {
   ...
   */
   ...
   function moveright(){
     ...
     if(right < 360) {window.requestAnimationFrame(moveright)}
   }
